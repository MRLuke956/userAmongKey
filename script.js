document.addEventListener('DOMContentLoaded', () => {
    ...
    class DiscordAuthSystem {
        ...
        async logout() {
            ...
            // ❌ REMOVIDO: await fetchUserKeyList(); - CAUSAVA LOOP INFINITO!
    ...
    async function fetchUserKeyList() {
        ...
        if (!discordAuth.isAuthenticated || !discordAuth.sessionId) {
            console.log('[fetchUserKeyList] User not authenticated, skipping');
            return;
        }
